...
//        Locale.setDefault(Locale.US);
        ...
        for (var locale : List.of(Locale.CANADA, Locale.CANADA_FRENCH, Locale.FRANCE, Locale.GERMANY,
                Locale.TAIWAN, Locale.JAPAN, Locale.ITALY, Locale.getDefault())) {
            System.out.println(
            ...
            System.out.println(decimalInfo.format(123456789.123456789));
        ...
        NumberFormat decimalInfo = NumberFormat.getNumberInstance(Locale.US);
